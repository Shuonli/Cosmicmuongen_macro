...
#include "/sphenix/user/shuhangli/hcalfullsim/macros/G4_HcalOut_ref.C"
...
// clear how well this works nowadays but it doesn't hurt either
  ...
  if (Enable::BLACKHOLE) BlackHole(g4Reco, 3000);
  ...
  // g4Reco->SetWorldSizeZ(3000.);
  //g4Reco->SetWorldSizeY(3000.);
  //g4Reco->SetWorldSizeX(3000.);
  WorldSize(g4Reco, 3000);
